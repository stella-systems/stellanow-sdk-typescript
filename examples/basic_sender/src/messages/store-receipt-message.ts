...
export class StoreReceiptMessage extends StellaNowMessageBase implements ToJSON {
    constructor(
        public readonly patron: string,
        public readonly local_shop: string,
        public readonly transaction_id: string
    ) {
        super('store_receipt', [new EntityType('patron', patron), new EntityType('local_shop', local_shop)]);
    }

    public toJSON(): object {
        return {
            transaction_id: Converters.convert(this.transaction_id),
            ...super.toJSON(),
        };
    }
}
